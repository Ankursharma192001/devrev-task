		...
		<div className="flex my-4  tablet:justify-between w-full tablet:my-4 desktop:z-20">
			...
			{!isLogin.status ? (
				<div className="flex gap-2 justify-end w-1/2">
					<Link to="/login">
						<button className="btn text-white px-2 py-1 rounded-md">Login</button>
					</Link>
					<Link to="/register">
						<button className="btn text-white px-2 py-1 rounded-md">Register</button>
					</Link>
				</div>
			) : (
				<div className="flex gap-2 justify-end w-1/2">
