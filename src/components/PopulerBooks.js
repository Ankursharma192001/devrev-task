    ...
    return (
        <div className='my-20' data-aos="fade-up"  data-aos-offset="200">
            <div className='flex items-center justify-between mb-4'>
                <p className='text-slate-800 font-semibold text-2xl tablet:text-3xl w-1/2 tablet:w-full'>Most Popular Books</p>
                <Link to='/register' className=' w-1/2 tablet:w-full justify-end flex'>
                    <p className='text-blue-600 font-medium text-lg hover:text-blue-800'>Figure Out More <span><KeyboardArrowRightIcon /></span></p>
                </Link>
            </div>
            <div>
